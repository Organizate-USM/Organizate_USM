...
!function(e) {
    ...
    r.prototype.buildTheBones = function() {
        ...
        !e.$elements.calendarEl.html()) {
            ...
            t += "</tr></table></div>",
            t += '<div class="calendar-events" ><div class="event-header"><p></p></div><div class="event-list" id="calEv"></div></div>',
    ...
    r.prototype.buildCalendar = function() {
		...
		diaDel = (t.$elements.innerEl.children()),
		$(diaDel).removeAttr('id'),
		r.addClass("calendar-active"),
		$(r).attr('id','dia-activo')),
    ...
    r.prototype.selectDate = function(e) {
		...
		diaDelete = i.$elements.innerEl.find("[data-date-val]"),
		$(diaDelete).removeAttr('id');
		n.addClass("calendar-active"),
		$(n).attr('id','dia-activo'),
        e || i.buildEventList(),
